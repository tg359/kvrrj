...
# from kvrrj.sri import (
#     SRI_DATA,
#     calculate_sri,
#     construction_sri,
#     estimate_sri_from_color,
...
#         6.737120211360634,
#     ]
#     for color_hex, thermal_emittance, result in zip(
#         color_hexs, thermal_emittances, results
#     ):
#         assert estimate_sri_from_color(
#             color_hex=color_hex, thermal_emittance=thermal_emittance
#         ) == pytest.approx(result, 0.001)
...
#             target_sri=target_sri, target_emittance=target_emittance
#         ) == pytest.approx(result, 0.001)
